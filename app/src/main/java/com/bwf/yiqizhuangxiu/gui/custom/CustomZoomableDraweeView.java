...
public class CustomZoomableDraweeView extends SimpleDraweeView {
    ...
    public CustomZoomableDraweeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomZoomableDraweeView(Context context, AttributeSet attrs, int defStyle) {
